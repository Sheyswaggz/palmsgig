...
export default function VerifyPhonePage() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Only allow alphanumeric (digits + uppercase letters) and limit to 6 characters
    const sanitizedValue = value.toUpperCase().replace(/[^A-Z0-9]/g, '').slice(0, 6);
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-2xl font-bold text-secondary-600">Verify your phone</h2>
