        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mb-4 text-gray-600">
              The leading marketplace connecting creators with brands for engaging social media tasks.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {footerLinks.product.map((link, index) => (
                <li key={index}>
                  <a href={link.href} className="text-gray-600 transition-colors hover:text-primary-600">
                    {link.label}
                  </a>
                </li>
              ))}
        ...
        <div className="mt-12 border-t pt-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <p className="text-sm text-gray-600">
              &copy; 2026 Palms Gig. All rights reserved.
            </p>
