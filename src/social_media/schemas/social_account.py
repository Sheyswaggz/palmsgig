...
class ManualLinkRequest(BaseModel):
    """
    Request schema for manually linking a social media account.

    Used to connect a social media account with just username.
    The account will be unverified until OAuth verification is completed.
