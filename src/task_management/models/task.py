...
class Task(BaseModel):
    ...
    # Override id to use String(36) to match database schema
    ...
    platform: Mapped[PlatformEnum] = mapped_column(
        SQLEnum(PlatformEnum, name="platform_enum", create_constraint=True, values_callable=lambda x: [e.value for e in x]),
        nullable=False,
        index=True,
    ...
    task_type: Mapped[TaskTypeEnum] = mapped_column(
        SQLEnum(TaskTypeEnum, name="task_type_enum", create_constraint=True, values_callable=lambda x: [e.value for e in x]),
        nullable=False,
        index=True,
    ...
    status: Mapped[TaskStatusEnum] = mapped_column(
        SQLEnum(TaskStatusEnum, name="task_status_enum", create_constraint=True, values_callable=lambda x: [e.value for e in x]),
        nullable=False,
