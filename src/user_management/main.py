...
This module provides the FastAPI application for the user management service
...
def create_application() -> FastAPI:
    ...
    app = FastAPI(
        ...
        version="0.1.0",
        description="User Management Service for PalmsGig Social Media Task Marketplace",
    ...
    async def health_check() -> dict[str, str]:
        ...
        Returns:
            Service status
        """
        return {"status": "healthy", "service": "user_management_service"}
    ...
    logger.info(
        "User Management Service application configured",
