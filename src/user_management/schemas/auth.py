...
class UpdateProfileRequest(BaseModel):
    ...
    fullName: Optional[str] = Field(None, description="Full name", alias="fullName")
    bio: Optional[str] = Field(None, description="User bio", max_length=500)
    profilePicture: Optional[str] = Field(None, description="Profile picture URL", alias="profilePicture")
